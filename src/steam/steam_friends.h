...
#include "steam/isteamfriends014.h"
#include "steam/isteamfriends015.h"
#include "steam/isteamfriends016.h"
#include "steam/isteamfriends017.h"
...
public:
    ...
    void GetFriendsGroupMembersList(FriendsGroupID_t friendsGroupID, CSteamID* pOutSteamIDMembers, int nMembersCount) override;
    ...
    void ActivateGameOverlayToWebPage(const char* pchURL, EActivateGameOverlayToWebPageMode eMode) override;
